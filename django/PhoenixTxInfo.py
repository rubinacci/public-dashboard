class PhoenixTxInfo:
    ...
    def get_header(self):
        ...
        txt = 'tx_hash,rn,timestamp,block_num,op_type,input_token_symbol,input_token_volume,input_token_fees,input_token_eth_price,output_token_symbol,output_token_fees,output_token_eth_price,eth_usd_price,delta_eth_price,link_eth_price,snx_eth_price,wbtc_eth_price,eth_balance,delta_balance,link_balance,snx_balance,wbtc_balance,eth_volume,delta_volume,link_volume,snx_volume,snx_volume,wbtc_volume,phoenix_supply,phoenix_genesis,phoenix_address,hourslot'
